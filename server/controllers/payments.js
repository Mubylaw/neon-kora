...
exports.createAccount = asyncHandler(async (req, res, next) => {
  ...
  const transaction_url = `https://api.korapay.com/merchant/api/v1/virtual-bank-account`;
...
exports.updateAccount = asyncHandler(async (req, res, next) => {
  ...
  const transaction_url = `https://api.korapay.com/merchant/api/v1/virtual-bank-account/${user.accountReference}`;
  const account = await axios(transaction_url, {
    method: "PATCH",
    data: options,
    headers: {
